...
pub struct PatchSmGPIO {
    ...
    // NOTE: C6-C9 are mismatched from the datasheet STM32 pin connections
    // This is to match the documented "CVx" numbering that is used everywhere
    pub c6: Option<gpio::gpioc::PC1<Analog>>,
    pub c7: Option<gpio::gpioc::PC0<Analog>>,
    pub c8: Option<gpio::gpiob::PB1<Analog>>,
    pub c9: Option<gpio::gpioc::PC4<Analog>>,
...
impl PatchSmGPIO {
    ...
    pub fn init(
        ...
        // Physical pin arguments stay in "physical" order to make this obvious,
        // and easier to confirm w/ datasheet..
        c6_phys: Option<gpio::gpiob::PB1<Analog>>,
        c7_phys: Option<gpio::gpioc::PC4<Analog>>,
        c8_phys: Option<gpio::gpioc::PC0<Analog>>,
        c9_phys: Option<gpio::gpioc::PC1<Analog>>,
        ...
        Self {
            ...
            c4,
            c5,
            // Remap to match expected CV ordering in datasheet, frontpanels, etc.
            c6: c9_phys,
            c7: c8_phys,
            c8: c6_phys,
            c9: c7_phys,
