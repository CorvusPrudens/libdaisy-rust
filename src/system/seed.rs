...
impl MinimalSeedSystem {
    ...
    pub fn new(resources: SystemResources) -> Self {
        ...
        // Set up GPIOs
        let gpio = crate::gpio::SeedGPIO::init(
            gpioc.pc7,
            gpiog.pg3,
            Some(gpiob.pb12),
            Some(gpioc.pc11),
        ...
        SeedSystem::init_debug(resources.dcb, resources.dwt);
...
impl SeedSystem {
    ...
    pub fn init(resources: SystemResources) -> SeedSystem {
